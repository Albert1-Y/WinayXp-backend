...
async (accessToken, refreshToken, profile, done) => {
  ...
  if (!user) {
    ...
    return done(null, false, { message: 'Usuario creado. Contacta al administrador para acceso.' });
  }
  if (!user.activo) {
    // Usuario existe pero está inactivo
    return done(null, false, { message: 'Usuario inactivo. Contacta al administrador para acceso.' });
  }

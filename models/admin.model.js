...
const creaEstudiante = async ({ dni, email, password, nombre_persona, apellido, rol, carrera, semestre }) => {
    try {
        
        const persona = await creaPersona({ dni, email, password, nombre_persona, apellido, rol: 'estudiante' });
...
const creaActividad = async ({idPersona,nombre_actividad,fecha_inicio,fecha_fin,lugar,creditos,semestre}) => {
    try {
...
export const AdminModel = {
    ...
    creaEstudiante,
    creaActividad,
    dataAlumno,DeleteAlumno,DeleteActividad,actividadExiste,
    mostrarActividad,mostrarEstudiantes, mostrarTutores,eliminarTutor
}
...
const login = async (req, res) => {
    try {
        ...
        const refreshtoken = jwt.sign({ email: user.email, rol: user.rol ,id_persona:user.id_persona},
        ...
        //crear acces token
        const token = jwt.sign({ email: user.email, rol: user.rol ,id_persona:user.id_persona},
            process.env.JWT_SECRET,
            {

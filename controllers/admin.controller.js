...
const register_Admin_tutor = async (req, res) => {
    try {
        ...
        const newUser = await AdminModel.creaPersona({dni, email, password: hashedPassword,nombre_persona,apellido,rol })
...
const registeEstudiante = async (req, res) => {
    try {
        ...
        const newUser = await AdminModel.creaEstudiante({dni, email, password: hashedPassword,nombre_persona,apellido,rol,carrera,semestre})
...
export const AdminController = {
    register_Admin_tutor,
     MostrarTutor,DeleteTutor
}
export const AdminSharedController = {
    registeEstudiante,DatosEstudiante,
    DeleteEstudiante,verifyGET, initMostrarEstudaintes,initAdminTutor,registerMultipleEstudiantes
}